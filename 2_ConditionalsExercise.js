...
function exercise1(num1) {
  ...
  function exercise4(varA, varB) {
    ...
    if(varA === varB) {
        ...
        answer4 = "varA and varB are different";
    }
    // --------------------------------------------
    // And above here
    // --------------------------------------------
  ...
  /**
   * In exercise 4, since we are using strictly equals (===), this means that the data
   * types must also match. This means that 4 === 4 would pass the test, but 4 === "4" 
   * would not, because although they are both 4, the lefthand side is a number while the 
   * other is a string. If you are not worried about data type then you could be more 
   * lenient and use == so that you could get true for 4 == "4". 
   */
  ...
  /**
   * There wasn't an exact question that I thought was difficult but the thing that 
   * I struggled with was remembering the syntax for switch cases. I had to look that 
   * up before I could complete some of the questions. Once I got the hang of it, 
   * I realized how simple they are and how effective they can be. This is the link I
   * used to reference the syntax:
