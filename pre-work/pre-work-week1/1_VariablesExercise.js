...
/**
 * The difference between num1 and num2 is that num1 is not inclusive, while num2 is 
 * inclusive. The numbers that are valid for num2 but not valid for num1 are 1 and 10.
 */
...
/**
 * The question I found a bit difficult was exercise 15. For reference it is: 
 * A + B * 2 + D + C / 2:
 * The reason for this is because I was trying to do it all at once in my head. 
 * The way I managed to get to the solution was writing it down on paper and slowly
 * through it manually. 
 * 
 * Another question I found difficult was question 16. For reference it is:
 * A * B
 * I am not sure how multiplying letters works in javascript so the way I solved this
 * was by googling how it works. I found this explanation: 
 * https://stackoverflow.com/questions/15604672/multiplying-a-letter-by-a-number
 * This is where i got my answer of NaN. 
 */
