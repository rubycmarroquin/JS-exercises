 ...
 */
function addPlayer(scoreBoardObj, nameOfPlayer, score) {
    scoreBoardObj[nameOfPlayer] = score;
 ...
 * If players violate the rules of the arcade hall, 
 * they are manually removed from the high score board. 
 * Define removePlayer which takes 2 parameters:
 * The first parameter is an existing score board object.
 * The second parameter is the name of the player as a string.
 * 
 * This function should remove the entry for the given player from the board
 * and return the board afterwards. If the player was not on the board in the first
 * place, nothing should happen to the board. It should be returned as is. 
 */
function removePlayer(scoreBoardObj, nameOfPlayer) {
    (scoreBoardObj.hasOwnProperty(nameOfPlayer) ? 
        delete scoreBoardObj[nameOfPlayer] : scoreBoardObj);
    return scoreBoardObj;
}
/** test case(s) */
 ...
 * will be added to the previous score on the board. 
 ...
 */
function updateScore(scoreBoardObj, nameOfPlayer, score) {
    scoreBoardObj[nameOfPlayer] += score;
    return scoreBoardObj;
}
/** test case(s) */
 ...
 */
function applyMondayBonus(scoreBoardObj) {
    for(let player in scoreBoardObj) scoreBoardObj[player] += 100;
    return scoreBoardObj;
}
/** test case(s) */
const scoreBoard = {
 ...
 * To celebrate the best arcade player in town, a player's score needs to 
 * be normalized so scores from different arcade halls become comparable.
 * 
 * Write a function normalizeScore. To practice your object skills, instead 
 * of two parameters this function should accept one object as a parameter. 
 ...
 * Your function normalizeScore should return the normalized score that you 
 * get after applying the normalization function to the score that was passed in. 
 */
